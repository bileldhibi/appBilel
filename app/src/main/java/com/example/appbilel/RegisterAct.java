...
public class RegisterAct extends AppCompatActivity {
    ...
    private EditText NomPrenom, Email, Cin, tfn, Mdp;
    private Button BtnR;
    private String NomPrenoms, Emails, Cins, tfns, Mdps;
    ...
    private void sendUserDate() {
        ...
        User user = new User(NomPrenoms, Emails, Cins, tfns);
    ...
    private boolean validate() {
        ...
        if (NomPrenoms.isEmpty() || NomPrenoms.length() < 7) {
            NomPrenom.setError("Nom et Prénom est invalide !");
